...
const button_hint = document.getElementById('button_hint');
...
output.innerHTML = '';
  ...
  elem.innerHTML =  movie.explanation;
...
button_hint.addEventListener('click', (e) => {


  const elem2 = document.createElement('div');
  elem2.classList.add('alert');
  output.innerHTML = '';

    elem2.classList.add('text');
    elem2.innerHTML =  ''+movie.hint;

  hint.appendChild(elem2);
});
